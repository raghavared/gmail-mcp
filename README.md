...
[![smithery badge](https://smithery.ai/badge/@raghavared/gmail-mcp)](https://smithery.ai/server/@raghavared/gmail-mcp)
...
To install Gmail AutoAuth for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@raghavared/gmail-mcp):
...
3. **Google Cloud Platform Setup:**
   - In your Google Cloud Console, add your custom domain callback URL (e.g., `https://domain.com/v2/auth/google/callback`) to the authorized redirect URIs list
...
1. **OAuth Keys Not Found**
   - Make sure `token.json` is in either your current directory or `~/.gmail-mcp/`
